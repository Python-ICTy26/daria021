...
class GameOfLife:
    ...
    def get_neighbours(self, cell: Cell) -> Cells:
        ...
        if x == 0 and y == 0:  # левый верхний угол
            ...
            a.extend([self.grid[x][y - 1], self.grid[x + 1][y], self.grid[x][y + 1], self.grid[x + 1][y + 1],
                      self.grid[x + 1][y - 1]])
            ...
            a.extend([self.grid[x - 1][y], self.grid[x - 1][y - 1], self.grid[x - 1][y + 1], self.grid[x][y - 1],
                      self.grid[x][y + 1]])
        elif y == 0 and x != 0 and x != self.cell_height - 1:  # левый стоблик
            a.extend([self.grid[x + 1][y], self.grid[x - 1][y], self.grid[x][y + 1], self.grid[x - 1][y + 1],
                      self.grid[x + 1][y + 1]])
        elif y == self.cell_width - 1 and x != 0 and x != self.cell_height - 1:  # правый столбк
            a.extend([self.grid[x][y - 1], self.grid[x - 1][y], self.grid[x + 1][y], self.grid[x - 1][y - 1],
                      self.grid[x + 1][y - 1]])
        else:
            a.extend([self.grid[x + 1][y], self.grid[x - 1][y], self.grid[x][y + 1], self.grid[x][y - 1],
